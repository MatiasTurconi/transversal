...
public class AlumnoData {
    ...
    public void guardarAlumno(Alumno alumno) {
        if(this.buscarAlumnoPorDNI(alumno.getDni()) == null){
            if(this.buscarAlumnoPorDNICheck(alumno.getDni())==null){
                ...
                JOptionPane.showMessageDialog(null, "Datos Repetidos Verificar Lista Alumnos");
    ...
    public Alumno buscarAlumnoPorDNICheck(int dni){
        Alumno alum=null;
        String sql="SELECT * FROM alumno WHERE dni=? AND estado=false";
        try {
            PreparedStatement ps=con.prepareStatement(sql);
            ps.setInt(1, dni);
            ResultSet rs=ps.executeQuery();
    ...
    public List<Alumno> alumnosBaja(){
        List<Alumno> alumnos=new ArrayList<>();
        String sql="SELECT * FROM alumno WHERE estado=?";
        try {
            PreparedStatement ps=con.prepareStatement(sql);
